        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-sharp fa-solid fa-laptop"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Inventario FMS</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseEquipos"
                   aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-solid fa-desktop fa-bounce"></i>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseConsumibles"
                   aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-solid fa-print"></i>
                    <span>Consumibles</span>
                </a>
                <div id="collapseConsumibles" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Inventario FMS</h1>
                    </div>
                </div>